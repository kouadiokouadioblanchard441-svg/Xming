...
const T: Record<Lang, Translations> = {
  fr: {
    ...
    myProductsNone:     "Aucun produit XPENG",
    ...
    aboutTitle:         "À propos de XPENG",
    aboutDesc1:         "XPENG est une plateforme d'investissement sécurisée qui vous permet de faire fructifier votre capital grâce à des produits VIP générateurs de revenus quotidiens.",
