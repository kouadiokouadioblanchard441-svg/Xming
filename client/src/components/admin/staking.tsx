                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="grid grid-cols-3 gap-2 text-sm">
                            ...
                            <div className="bg-secondary/50 rounded-lg p-2 text-center">
                              ...
                              <p className="font-bold text-gray-600">{sp.returnAmount.toLocaleString()} FCFA</p>
                            </div>
                            <div className="bg-secondary/50 rounded-lg p-2 text-center">
        ...
        <TabsContent value="stakings" className="space-y-4 mt-4">
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="bg-secondary rounded-xl p-3 text-center">
              ...
              <p className="font-bold text-gray-600">{totalStaked.toLocaleString()} FCFA</p>
            </div>
            <div className="bg-secondary rounded-xl p-3 text-center">
              <p className="text-xs text-muted-foreground">Total libéré</p>
              <p className="font-bold text-gray-600">{totalReleased.toLocaleString()} FCFA</p>
            </div>
          </div>
